...
<div class="modal fade" id="modal-folder-create">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="{{route('admin_upload_folder')}}"
...
<div class="modal fade" id="modal-file-delete">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form method="POST" action="{{route('admin_upload_deletefile')}}">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<div class="modal fade" id="modal-folder-delete">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form method="POST" action="{{route('admin_upload_deletefolder')}}">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<input type="hidden" name="_method" value="DELETE">
					<input type="hidden" name="folder" value="{{ $folder }}">
...
<div class="modal fade" id="modal-file-upload">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="{{route('admin_upload_file')}}"
